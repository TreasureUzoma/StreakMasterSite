                ...
                <div className="flex justify-center w-full">
                    <div className="w-full flex items-center justify-between my_fixed_width">
                        ...
                        <a
                            ...
                            className="rounded-3xl border border-[2px] border-black text-center bg-white text-sm font-bold py-2 px-6 text-black my-2 hidden md:flex"
                        >
                            Get Started
                        </a>
                    </div>
