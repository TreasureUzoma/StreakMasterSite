  ...
  return (
    <header className="h-[65vh] mt-[5.4rem] flex justify-center items-center text-center px-10 ">
      <div className ="my_fixed_width_2">
        ...
        <a href="https://streakmaster.vercel.app/" className="inline-flex items-center justify-between bg-gray-300 px-5 py-3 rounded-3xl text-[0.78rem] font-bold w-[8.5rem] text-black my-3">
